...
function useStaticContent() {
  ...
  useEffect(() => {
    ...
    const isEmpty = ref.current && (ref.current as HTMLElement).innerHTML === ''
    if (isEmpty) {
      setRender(true)
    }
  }, [])
...
export default function StaticContent({ children, element = 'div', ...props } : { children: React.ReactNode, element?: string, [key: string]: any }) {
